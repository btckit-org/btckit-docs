...
import { githubBtcKitUrl } from '../constants';
              ...
              <div className="mx-auto max-w-2xl">
                <div className="max-w-lg">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-100">
                    A very short and readable standard designed to converge the Bitcoin ecosystem.
                    While the bulk of the standard is very simple, but strict &mdash; many parts of
                    the standard are intentionally kept loose to allow for experimentation and
                    future-proofness.
                      ...
                      <div className="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                        <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                          <div className="-mb-px flex text-sm font-medium leading-6 text-gray-400">
                            ...
                            <div className="border-r border-gray-600/10 py-2 px-4">Page.tsx</div>
                          </div>
                        </div>
      ...
      <div className="bg-gradient-to-b py-16 dark:from-slate-100/20 sm:py-24">
        <div className="mx-auto max-w-7xl px-8 md:px-32 lg:px-48">
          <div className="mx-auto mb-28 max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-100">
              The core idea behind BtcKit has been in the works for a while. Now, given the
              increasing interest in Ordinals, it is a great time to release the protocol.
              <br />
          ...
          <dl className="col-span-2 grid grid-cols-1 gap-x-16 gap-y-10 text-base leading-6 text-gray-600 dark:text-gray-200 sm:grid-cols-2 lg:gap-y-10">
            {roadmap.map(feature => (
              <div key={feature.name} className="">
                <dt className="font-semibold text-gray-900 dark:text-orange-50">{feature.name}</dt>
